...
本 repo fork 自 [Miguok/fable-harness](https://github.com/Miguok/fable-harness)，保留原作者的授权与 commit 归属。

对上游的实质贡献：PR [#3](https://github.com/Miguok/fable-harness/pull/3)（`verify_gate` fail-open 静默失败修正）虽未直接合并，但原作者采纳了其中的做法并重写进上游 commit [`b6f794e`](https://github.com/Miguok/fable-harness/commit/b6f794e)，标注 `Co-authored-by: Atis <atis.tw@gmail.com>`，已收录于上游 v1.0.2（`.gate_fail` fail-open telemetry）。
